        ...
        <div class="row p-1">
            <div class="col-12 py-1">
                <div class="alert bg-gray btn-point" role="alert">
                    <i class="fas fa-location-arrow"></i>&nbsp; Add Quarantine Location Type
                </div> <!-- alert -->
            </div> <!-- ./col12 -->
            <div class="col-12 py-1">
                <button type="button" class="btn btn-point btn-flat btn-danger" id="transactionbutton" name="transactionbutton">
                    <i class="fas fa-location-arrow"></i> &nbsp;New Location Type</button>
            </div> <!-- ./col12 -->
            <div class="col-12 py-1">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modalevenrow">
                <div class="modal-header modalevenrow">
                    <h4 class="modal-title text-primary"><i class="fas fa-location-arrow"></i>&nbsp;&nbsp;Custom Ajax Title </h4>
                ...
                <form id="ajaxmodalform" method="post" class="form-horizontal">
                    <div class="modal-body modalevenrow text-dark">
                        <div class="row p-2 modalevenrow">
                            <div class="col-4 d-flex justify-content-end"> Location Type Name
                            </div> <!-- ./col4 -->
                            <div class="col-8">
                                <input type="text" name="loctypename" id="loctypename" value="" class="form-control col-6 btn-point" required minlength="2" maxlength="30">
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#master_table").DataTable({
                ...
                columns: [

                    {
                        ...
                        defaultContent: "",
                        data: 'loctypename',
                        title: 'Name Of Quarantine location Type'
                    },
            ...
            $("#transactionbutton").click(function(event){
                ...
                $('.modal-title').text('Add New Quarantine Location Type');
            ...
            $('#loctypename').on('keydown ', function(e) {
            ...
            $('#ajaxmodalform').on('submit', function(event){
                ...
                if($('#loctypename').val() == ''){
                    ...
                    if($('#action').val() == 'Add')
                        action_url = "{{ route('qlocation.insert') }}";

                    if($('#action').val() == 'Edit')
                        action_url = "{{ route('qlocation.usertypeupdate') }}";
            ...
            $(document).on('click', '.edit', function(){
                ...
                $('#ajaxformresults').html('');
                $.ajax({
                    url :"/admin/ltypeedit/"+id,
                    dataType:"json",
                    success:function(data)
                    {
                        $('#loctypename').val(data.userdata.loctypename);
            ...
            $('#ok_button').click(function(){
                ...
                $.ajax({
                    url:"/admin/qldistroy/"+element_id,
                    dataType:"json",
