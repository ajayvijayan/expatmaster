 ...
 <div class="row p-1 ">
    <div class="col-12 pt-3">
      <div class="alert bg-gray btn-point" role="alert">
         <i class="fas fa-list-alt"></i>&nbsp; Institution Quarantine List
      </div> <!-- ./alert -->
    </div> <!-- ./col12 -->
  </div> <!-- ./row -->
  @if(Auth::user()->usertype == 'Data entry operator')
  <form action="{{ route('deo.filterinstitutionlist') }}" name="housevisitlist" method="post">
  @elseif(Auth::user()->usertype == 'Lsg official')  
  <form action="{{ route('lsg.filterinstitutionlist') }}" name="housevisitlist" method="post">
    @elseif(Auth::user()->usertype == 'phcmo')  
  <form action="{{ route('phc.filterinstitutionlist') }}" name="housevisitlist" method="post">
  @endif 
    @csrf
  <div class="row p-1 ">
    <div class="col-12 pt-3">
