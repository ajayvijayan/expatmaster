        ...
        <div class="row p-1">
            ...
            <div class="col-12 py-1">
                <button type="button" class="btn btn-point btn-flat btn-danger" id="transactionbutton" name="transactionbutton">
                    <i class="fas fa-plus-circle"></i> &nbsp;Add New Symptoms</button>
            </div> <!-- ./col12 -->
            <div class="col-12 py-1">
                ...
                <form id="ajaxmodalform" method="post" class="form-horizontal">
                    <div class="modal-body modalevenrow text-dark">
                        <div class="row p-2 modalevenrow">
                            <div class="col-4 d-flex justify-content-end"> Symptom Name
                            </div> <!-- ./col4 -->
                            <div class="col-8">
        ...
        $(document).ready(function(){
            ...
            $('#ajaxmodalform').on('submit', function(event){
                ...
                if($('#name').val() == ''){
                    ...
                    if($('#action').val() == 'Add')
                        action_url = "{{ route('symptom.insert') }}";

                    if($('#action').val() == 'Edit')
                        action_url = "{{ route('symptom.symptomupdate') }}";
            ...
            $('#ok_button').click(function(){
                ...
                $.ajax({
                    url:"/admin/symptomdistroy/"+element_id,
                    dataType:"json",
