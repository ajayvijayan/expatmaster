                                ...
                                <!--Grid column-->
                                    <div class="col-md-12 px-5">
                                        <div class="md-form mb-0 ">
                                            ...
                                            <input type="text" id="orangeForm-name" class="form-control indigo-text" placeholder="Username">
                                        </div>
                                        <div class="md-form mb-0">
                                            <i class="fas fa-lock prefix blue-text"></i>
                                            <input type="password" id="orangeForm-pass" class="form-control indigo-text" placeholder="Password">
                                        </div>
  ...
  <!-- Copyright-->
        <div class="footer-copyright text-center py-3">
            <div class="container-fluid">
                <span class="eng_xxxs"> Designed and Developed by: <a href="http://cdit.org" target="_blank" data-toggle="tooltip" title="This will open an external website."> C-DIT </a> </span>
            </div>
        </div>
        <!--/.Copyright -->
    </footer>
